    ...
    fetch(uri).then(response => {
      response.text().then(text => {
        ...
        if(vars.includes('awesomeEffect'))
          inputAwesomeEffect = $response.querySelector('.SiteUser_Page_awesomeEffect');
        ...
        if(vars.includes('webComponentsTheme'))
          inputWebComponentsTheme = $response.querySelector('.SiteUser_Page_webComponentsTheme');
        ...
        if(inputAwesomeEffect) {
          document.querySelectorAll('.SiteUser_Page_awesomeEffect').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputAwesomeEffect.getAttribute('value');
            else
              item.textContent = inputAwesomeEffect.textContent;
          });
          addGlow(document.querySelector('.SiteUser_Page_awesomeEffect'));
        }
        ...
        if(inputWebComponentsTheme) {
          document.querySelectorAll('.SiteUser_Page_webComponentsTheme').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputWebComponentsTheme.getAttribute('value');
            else
              item.textContent = inputWebComponentsTheme.textContent;
          });
          addGlow(document.querySelector('.SiteUser_Page_webComponentsTheme'));
        }

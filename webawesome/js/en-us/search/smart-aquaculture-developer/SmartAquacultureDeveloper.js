    ...
    fetch(uri).then(response => {
      response.text().then(text => {
        ...
        if(vars.includes('modified'))
          inputModified = $response.querySelector('.SmartAquacultureDeveloper_Page_modified');
        if(vars.includes('archived'))
          inputArchived = $response.querySelector('.SmartAquacultureDeveloper_Page_archived');
        ...
        if(vars.includes('pageId'))
          inputPageId = $response.querySelector('.SmartAquacultureDeveloper_Page_pageId');
        if(vars.includes('displayPage'))
          inputDisplayPage = $response.querySelector('.SmartAquacultureDeveloper_Page_displayPage');
        if(vars.includes('classCanonicalName'))
          inputClassCanonicalName = $response.querySelector('.SmartAquacultureDeveloper_Page_classCanonicalName');
        if(vars.includes('classSimpleName'))
          inputClassSimpleName = $response.querySelector('.SmartAquacultureDeveloper_Page_classSimpleName');
        if(vars.includes('classCanonicalNames'))
          inputClassCanonicalNames = $response.querySelector('.SmartAquacultureDeveloper_Page_classCanonicalNames');
        if(vars.includes('saves'))
          inputSaves = $response.querySelector('.SmartAquacultureDeveloper_Page_saves');
        if(vars.includes('objectTitle'))
          inputObjectTitle = $response.querySelector('.SmartAquacultureDeveloper_Page_objectTitle');
        if(vars.includes('editPage'))
          inputEditPage = $response.querySelector('.SmartAquacultureDeveloper_Page_editPage');
        if(vars.includes('userPage'))
          inputUserPage = $response.querySelector('.SmartAquacultureDeveloper_Page_userPage');
        if(vars.includes('download'))
          inputDownload = $response.querySelector('.SmartAquacultureDeveloper_Page_download');
        if(vars.includes('objectSuggest'))
          inputObjectSuggest = $response.querySelector('.SmartAquacultureDeveloper_Page_objectSuggest');
        ...
        if(inputCreated) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_created').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputCreated.getAttribute('value');
            else
              item.textContent = inputCreated.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_created'));
        }

        if(inputModified) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_modified').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputModified.getAttribute('value');
            else
              item.textContent = inputModified.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_modified'));
        }

        if(inputArchived) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_archived').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputArchived.getAttribute('value');
            else
              item.textContent = inputArchived.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_archived'));
        }

        if(inputName) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_name').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputName.getAttribute('value');
            else
              item.textContent = inputName.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_name'));
        }

        if(inputDescription) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_description').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
        ...
        if(inputPageImageUri) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_pageImageUri').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageUri.getAttribute('value');
            else
              item.textContent = inputPageImageUri.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_pageImageUri'));
        }

        if(inputPageId) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_pageId').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageId.getAttribute('value');
            else
              item.textContent = inputPageId.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_pageId'));
        }

        if(inputDisplayPage) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_displayPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDisplayPage.getAttribute('value');
            else
              item.textContent = inputDisplayPage.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_displayPage'));
        }

        if(inputClassCanonicalName) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_classCanonicalName').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassCanonicalName.getAttribute('value');
            else
              item.textContent = inputClassCanonicalName.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_classCanonicalName'));
        }

        if(inputClassSimpleName) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_classSimpleName').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassSimpleName.getAttribute('value');
            else
              item.textContent = inputClassSimpleName.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_classSimpleName'));
        }

        if(inputClassCanonicalNames) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_classCanonicalNames').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassCanonicalNames.getAttribute('value');
            else
              item.textContent = inputClassCanonicalNames.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_classCanonicalNames'));
        }

        if(inputSaves) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_saves').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputSaves.getAttribute('value');
            else
              item.textContent = inputSaves.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_saves'));
        }

        if(inputObjectTitle) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_objectTitle').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectTitle.getAttribute('value');
            else
              item.textContent = inputObjectTitle.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_objectTitle'));
        }

        if(inputEditPage) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_editPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputEditPage.getAttribute('value');
            else
              item.textContent = inputEditPage.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_editPage'));
        }

        if(inputUserPage) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_userPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputUserPage.getAttribute('value');
            else
              item.textContent = inputUserPage.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_userPage'));
        }

        if(inputDownload) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_download').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDownload.getAttribute('value');
            else
              item.textContent = inputDownload.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_download'));
        }

        if(inputObjectSuggest) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_objectSuggest').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectSuggest.getAttribute('value');
            else
              item.textContent = inputObjectSuggest.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_objectSuggest'));
        }

        if(inputObjectText) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_objectText').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectText.getAttribute('value');
            else
              item.textContent = inputObjectText.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_objectText'));
        }

        if(inputSolrId) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_solrId').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
        ...
        if(inputCourseNum) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_courseNum').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputCourseNum.getAttribute('value');
            else
              item.textContent = inputCourseNum.textContent;
          });
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_courseNum'));
        }

        if(inputLessonNum) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_lessonNum').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
        ...
        if(inputPageImageAlt) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_pageImageAlt').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
        ...
        if(inputNextArticles) {
          ...
          addGlow(document.querySelector('.SmartAquacultureDeveloper_Page_nextArticles'));
        }

        if(inputLabelsString) {
          document.querySelectorAll('.SmartAquacultureDeveloper_Page_labelsString').forEach((item, index) => {
            if(typeof item.value !== 'undefined')

Promise.all([
    ...
    , customElements.whenDefined('wa-dropdown')
          ...
          // PATCH created
          document.querySelector('#SmartAquacultureDeveloper_Page_created')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_created')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_created')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_created');
            const valid = form.reportValidity();
          });

          // PATCH archived
          document.querySelector('#SmartAquacultureDeveloper_Page_archived')?.addEventListener('click', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_archived')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_archived')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_archived');
            const valid = form.reportValidity();
          });

          // PATCH name
          document.querySelector('#SmartAquacultureDeveloper_Page_name')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_name')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_name')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_name');
            const valid = form.reportValidity();
          });

          // PATCH description
          document.querySelector('#SmartAquacultureDeveloper_Page_description')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_description')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_description')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_description');
            const valid = form.reportValidity();
          });
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_authorUrl')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          ...
          // PATCH pageImageUri
          document.querySelector('#SmartAquacultureDeveloper_Page_pageImageUri')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_pageImageUri')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_pageImageUri')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_pageImageUri');
            const valid = form.reportValidity();
          });

          // PATCH pageId
          document.querySelector('#SmartAquacultureDeveloper_Page_pageId')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_pageId')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_pageId')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_pageId');
            const valid = form.reportValidity();
          });

          // PATCH displayPage
          document.querySelector('#SmartAquacultureDeveloper_Page_displayPage')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_displayPage')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_displayPage')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_displayPage');
            const valid = form.reportValidity();
          });

          // PATCH objectTitle
          document.querySelector('#SmartAquacultureDeveloper_Page_objectTitle')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_objectTitle')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_objectTitle')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_objectTitle');
            const valid = form.reportValidity();
          });

          // PATCH editPage
          document.querySelector('#SmartAquacultureDeveloper_Page_editPage')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_editPage')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_editPage')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_editPage');
            const valid = form.reportValidity();
          });

          // PATCH userPage
          document.querySelector('#SmartAquacultureDeveloper_Page_userPage')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_userPage')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_userPage')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_userPage');
            const valid = form.reportValidity();
          });

          // PATCH download
          document.querySelector('#SmartAquacultureDeveloper_Page_download')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_download')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_download')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_download');
            const valid = form.reportValidity();
          });

          // PATCH solrId
          document.querySelector('#SmartAquacultureDeveloper_Page_solrId')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_solrId')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#SmartAquacultureDeveloper_Page_solrId')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_solrId');
            const valid = form.reportValidity();
          });
          ...
          document.querySelector('#SmartAquacultureDeveloper_Page_labelsString')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });

Promise.all([
    ...
    , customElements.whenDefined('wa-dropdown')
          ...
          // PATCH gkeStagingEnvironments
          document.querySelector('#Contract_Page_gkeStagingEnvironments')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_gkeStagingEnvironments');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setGkeStagingEnvironments', event.currentTarget.value
                  , event.currentTarget
                , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_gkeStagingEnvironments')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_gkeStagingEnvironments')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_gkeStagingEnvironments');
            const valid = form.reportValidity();
          });

          // PATCH openshiftDedicatedManagementClusters
          document.querySelector('#Contract_Page_openshiftDedicatedManagementClusters')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftDedicatedManagementClusters');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftDedicatedManagementClusters', event.currentTarget.value
                  , event.currentTarget
                , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftDedicatedManagementClusters')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftDedicatedManagementClusters')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftDedicatedManagementClusters');
            const valid = form.reportValidity();
          });

          // PATCH openshiftDedicatedWorkerClusters
          document.querySelector('#Contract_Page_openshiftDedicatedWorkerClusters')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftDedicatedWorkerClusters');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftDedicatedWorkerClusters', event.currentTarget.value
                  , event.currentTarget
                , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftDedicatedWorkerClusters')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftDedicatedWorkerClusters')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftDedicatedWorkerClusters');
            const valid = form.reportValidity();
          });
          ...
          // PATCH managementClusterNodes
          document.querySelector('#Contract_Page_managementClusterNodes')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_managementClusterNodes');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setManagementClusterNodes', event.currentTarget.value
                  , event.currentTarget
                , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_managementClusterNodes')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_managementClusterNodes')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_managementClusterNodes');
            const valid = form.reportValidity();
          });

          // PATCH workerClusterApplicationNodes
          document.querySelector('#Contract_Page_workerClusterApplicationNodes')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_workerClusterApplicationNodes');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setWorkerClusterApplicationNodes', event.currentTarget.value
                  , event.currentTarget
                , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_workerClusterApplicationNodes')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_workerClusterApplicationNodes')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_workerClusterApplicationNodes');
            const valid = form.reportValidity();
          });
          ...
          // PATCH openshiftManagementClusterWorkerNodesPerYear
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftManagementClusterWorkerNodesPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftManagementClusterWorkerNodesPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftManagementClusterWorkerNodesPerYear');
            const valid = form.reportValidity();
          });

          // PATCH openshiftApplicationClusterWorkerNodesPerYear
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftApplicationClusterWorkerNodesPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftApplicationClusterWorkerNodesPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftApplicationClusterWorkerNodesPerYear');
            const valid = form.reportValidity();
          });

          // PATCH openshiftWorkerNodesPerYear
          document.querySelector('#Contract_Page_openshiftWorkerNodesPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftWorkerNodesPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftWorkerNodesPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftWorkerNodesPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftWorkerNodesPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftWorkerNodesPerYear');
            const valid = form.reportValidity();
          });

          // PATCH openshiftManagementClusterWorkerCoresPerYear
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftManagementClusterWorkerCoresPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftManagementClusterWorkerCoresPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftManagementClusterWorkerCoresPerYear');
            const valid = form.reportValidity();
          });

          // PATCH openshiftApplicationClusterWorkerCoresPerYear
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftApplicationClusterWorkerCoresPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftApplicationClusterWorkerCoresPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftApplicationClusterWorkerCoresPerYear');
            const valid = form.reportValidity();
          });

          // PATCH openshiftWorkerCoresPerYear
          document.querySelector('#Contract_Page_openshiftWorkerCoresPerYear')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftWorkerCoresPerYear');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftWorkerCoresPerYear', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftWorkerCoresPerYear')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftWorkerCoresPerYear')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftWorkerCoresPerYear');
            const valid = form.reportValidity();
          });
          ...
          // PATCH employeePayPerYearDataset
          document.querySelector('#Contract_Page_employeePayPerYearDataset')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_employeePayPerYearDataset');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setEmployeePayPerYearDataset', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_employeePayPerYearDataset')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_employeePayPerYearDataset')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_employeePayPerYearDataset');
            const valid = form.reportValidity();
          });
          ...
          // PATCH openshiftCostsPerClusterPerYearDataset
          document.querySelector('#Contract_Page_openshiftCostsPerClusterPerYearDataset')?.addEventListener('change', (event) => {
            const form = document.querySelector('#PageForm_openshiftCostsPerClusterPerYearDataset');
            const valid = form.checkValidity();
            if(valid) {
              patchContractVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'contractId:' + event.currentTarget.getAttribute('data-contractId') }]
                  , 'setOpenshiftCostsPerClusterPerYearDataset', event.currentTarget.value == '' ? null : JSON.parse(event.currentTarget.value)
                  , event.currentTarget
                  , function(response, target) { addGlow(target); }
                  , function(response, target) { addError(target); }
                  );
          ...
          document.querySelector('#Contract_Page_openshiftCostsPerClusterPerYearDataset')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Contract_Page_openshiftCostsPerClusterPerYearDataset')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_openshiftCostsPerClusterPerYearDataset');
            const valid = form.reportValidity();
          });

Promise.all([
  ...
  document.querySelector('#pageSelectSortContract_gkeStagingEnvironments')?.addEventListener('change', (event) => {
    sort('Contract', 'gkeStagingEnvironments', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_gkeStagingEnvironments')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'gkeStagingEnvironments', true);
  });
  document.querySelector('#pageStatsContract_gkeStagingEnvironments')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'gkeStagingEnvironments', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftDedicatedManagementClusters')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftDedicatedManagementClusters', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftDedicatedManagementClusters')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftDedicatedManagementClusters', true);
  });
  document.querySelector('#pageStatsContract_openshiftDedicatedManagementClusters')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftDedicatedManagementClusters', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftDedicatedWorkerClusters')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftDedicatedWorkerClusters', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftDedicatedWorkerClusters')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftDedicatedWorkerClusters', true);
  });
  document.querySelector('#pageStatsContract_openshiftDedicatedWorkerClusters')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftDedicatedWorkerClusters', false);
  });
  ...
  document.querySelector('#pageSelectSortContract_managementClusterNodes')?.addEventListener('change', (event) => {
    sort('Contract', 'managementClusterNodes', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_managementClusterNodes')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'managementClusterNodes', true);
  });
  document.querySelector('#pageStatsContract_managementClusterNodes')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'managementClusterNodes', false);
  });

  document.querySelector('#pageSelectSortContract_workerClusterApplicationNodes')?.addEventListener('change', (event) => {
    sort('Contract', 'workerClusterApplicationNodes', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_workerClusterApplicationNodes')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'workerClusterApplicationNodes', true);
  });
  document.querySelector('#pageStatsContract_workerClusterApplicationNodes')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'workerClusterApplicationNodes', false);
  });
  ...
  document.querySelector('#pageSelectSortContract_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftManagementClusterWorkerNodesPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftManagementClusterWorkerNodesPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftManagementClusterWorkerNodesPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftManagementClusterWorkerNodesPerYear', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftApplicationClusterWorkerNodesPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftApplicationClusterWorkerNodesPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftApplicationClusterWorkerNodesPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftApplicationClusterWorkerNodesPerYear', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftWorkerNodesPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftWorkerNodesPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftWorkerNodesPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftWorkerNodesPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftWorkerNodesPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftWorkerNodesPerYear', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftManagementClusterWorkerCoresPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftManagementClusterWorkerCoresPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftManagementClusterWorkerCoresPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftManagementClusterWorkerCoresPerYear', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftApplicationClusterWorkerCoresPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftApplicationClusterWorkerCoresPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftApplicationClusterWorkerCoresPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftApplicationClusterWorkerCoresPerYear', false);
  });

  document.querySelector('#pageSelectSortContract_openshiftWorkerCoresPerYear')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftWorkerCoresPerYear', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftWorkerCoresPerYear')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftWorkerCoresPerYear', true);
  });
  document.querySelector('#pageStatsContract_openshiftWorkerCoresPerYear')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftWorkerCoresPerYear', false);
  });
  ...
  document.querySelector('#pageSelectSortContract_employeePayPerYearDataset')?.addEventListener('change', (event) => {
    sort('Contract', 'employeePayPerYearDataset', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_employeePayPerYearDataset')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'employeePayPerYearDataset', true);
  });
  document.querySelector('#pageStatsContract_employeePayPerYearDataset')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'employeePayPerYearDataset', false);
  });
  ...
  document.querySelector('#pageSelectSortContract_openshiftCostsPerClusterPerYearDataset')?.addEventListener('change', (event) => {
    sort('Contract', 'openshiftCostsPerClusterPerYearDataset', event.currentTarget.value);
  });

  document.querySelector('#pageStatsContract_openshiftCostsPerClusterPerYearDataset')?.addEventListener('wa-show', (event) => {
    facetStatsChange('Contract', 'openshiftCostsPerClusterPerYearDataset', true);
  });
  document.querySelector('#pageStatsContract_openshiftCostsPerClusterPerYearDataset')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('Contract', 'openshiftCostsPerClusterPerYearDataset', false);
  });

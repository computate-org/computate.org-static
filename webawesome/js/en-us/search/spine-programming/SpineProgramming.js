    ...
    fetch(uri).then(response => {
      response.text().then(text => {
        ...
        if(vars.includes('created'))
          inputCreated = $response.querySelector('.SpineProgramming_Page_created');
        if(vars.includes('modified'))
          inputModified = $response.querySelector('.SpineProgramming_Page_modified');
        if(vars.includes('archived'))
          inputArchived = $response.querySelector('.SpineProgramming_Page_archived');
        if(vars.includes('authorName'))
          inputAuthorName = $response.querySelector('.SpineProgramming_Page_authorName');
        if(vars.includes('authorUrl'))
          inputAuthorUrl = $response.querySelector('.SpineProgramming_Page_authorUrl');
        if(vars.includes('pageImageUri'))
          inputPageImageUri = $response.querySelector('.SpineProgramming_Page_pageImageUri');
        if(vars.includes('pageId'))
          inputPageId = $response.querySelector('.SpineProgramming_Page_pageId');
        if(vars.includes('displayPage'))
          inputDisplayPage = $response.querySelector('.SpineProgramming_Page_displayPage');
        if(vars.includes('classCanonicalName'))
          inputClassCanonicalName = $response.querySelector('.SpineProgramming_Page_classCanonicalName');
        if(vars.includes('classSimpleName'))
          inputClassSimpleName = $response.querySelector('.SpineProgramming_Page_classSimpleName');
        if(vars.includes('classCanonicalNames'))
          inputClassCanonicalNames = $response.querySelector('.SpineProgramming_Page_classCanonicalNames');
        if(vars.includes('saves'))
          inputSaves = $response.querySelector('.SpineProgramming_Page_saves');
        if(vars.includes('objectTitle'))
          inputObjectTitle = $response.querySelector('.SpineProgramming_Page_objectTitle');
        if(vars.includes('editPage'))
          inputEditPage = $response.querySelector('.SpineProgramming_Page_editPage');
        if(vars.includes('userPage'))
          inputUserPage = $response.querySelector('.SpineProgramming_Page_userPage');
        if(vars.includes('download'))
          inputDownload = $response.querySelector('.SpineProgramming_Page_download');
        if(vars.includes('objectSuggest'))
          inputObjectSuggest = $response.querySelector('.SpineProgramming_Page_objectSuggest');
        if(vars.includes('objectText'))
          inputObjectText = $response.querySelector('.SpineProgramming_Page_objectText');
        if(vars.includes('solrId'))
          inputSolrId = $response.querySelector('.SpineProgramming_Page_solrId');
        if(vars.includes('importance'))
          inputImportance = $response.querySelector('.SpineProgramming_Page_importance');
        if(vars.includes('courseNum'))
          inputCourseNum = $response.querySelector('.SpineProgramming_Page_courseNum');
        if(vars.includes('lessonNum'))
          inputLessonNum = $response.querySelector('.SpineProgramming_Page_lessonNum');
        if(vars.includes('name'))
          inputName = $response.querySelector('.SpineProgramming_Page_name');
        if(vars.includes('description'))
          inputDescription = $response.querySelector('.SpineProgramming_Page_description');
        if(vars.includes('pageVideoUrl'))
          inputPageVideoUrl = $response.querySelector('.SpineProgramming_Page_pageVideoUrl');
        if(vars.includes('pageImageWidth'))
          inputPageImageWidth = $response.querySelector('.SpineProgramming_Page_pageImageWidth');
        if(vars.includes('pageImageHeight'))
          inputPageImageHeight = $response.querySelector('.SpineProgramming_Page_pageImageHeight');
        if(vars.includes('pageImageType'))
          inputPageImageType = $response.querySelector('.SpineProgramming_Page_pageImageType');
        if(vars.includes('pageImageAlt'))
          inputPageImageAlt = $response.querySelector('.SpineProgramming_Page_pageImageAlt');
        if(vars.includes('prerequisiteArticleIds'))
          inputPrerequisiteArticleIds = $response.querySelector('.SpineProgramming_Page_prerequisiteArticleIds');
        if(vars.includes('prerequisiteArticles'))
          inputPrerequisiteArticles = $response.querySelector('.SpineProgramming_Page_prerequisiteArticles');
        if(vars.includes('nextArticleIds'))
          inputNextArticleIds = $response.querySelector('.SpineProgramming_Page_nextArticleIds');
        if(vars.includes('nextArticles'))
          inputNextArticles = $response.querySelector('.SpineProgramming_Page_nextArticles');
        if(vars.includes('labelsString'))
          inputLabelsString = $response.querySelector('.SpineProgramming_Page_labelsString');
        if(vars.includes('labels'))
          inputLabels = $response.querySelector('.SpineProgramming_Page_labels');
        if(vars.includes('relatedArticleIds'))
          inputRelatedArticleIds = $response.querySelector('.SpineProgramming_Page_relatedArticleIds');
        if(vars.includes('relatedArticles'))
          inputRelatedArticles = $response.querySelector('.SpineProgramming_Page_relatedArticles');
        ...
        if(inputCreated) {
          document.querySelectorAll('.SpineProgramming_Page_created').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputCreated.getAttribute('value');
            else
              item.textContent = inputCreated.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_created'));
        }

        if(inputModified) {
          document.querySelectorAll('.SpineProgramming_Page_modified').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputModified.getAttribute('value');
            else
              item.textContent = inputModified.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_modified'));
        }

        if(inputArchived) {
          document.querySelectorAll('.SpineProgramming_Page_archived').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputArchived.getAttribute('value');
            else
              item.textContent = inputArchived.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_archived'));
        }

        if(inputAuthorName) {
          document.querySelectorAll('.SpineProgramming_Page_authorName').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputAuthorName.getAttribute('value');
            else
              item.textContent = inputAuthorName.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_authorName'));
        }

        if(inputAuthorUrl) {
          document.querySelectorAll('.SpineProgramming_Page_authorUrl').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputAuthorUrl.getAttribute('value');
            else
              item.textContent = inputAuthorUrl.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_authorUrl'));
        }

        if(inputPageImageUri) {
          document.querySelectorAll('.SpineProgramming_Page_pageImageUri').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageUri.getAttribute('value');
            else
              item.textContent = inputPageImageUri.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageImageUri'));
        }

        if(inputPageId) {
          document.querySelectorAll('.SpineProgramming_Page_pageId').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageId.getAttribute('value');
            else
              item.textContent = inputPageId.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageId'));
        }

        if(inputDisplayPage) {
          document.querySelectorAll('.SpineProgramming_Page_displayPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDisplayPage.getAttribute('value');
            else
              item.textContent = inputDisplayPage.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_displayPage'));
        }

        if(inputClassCanonicalName) {
          document.querySelectorAll('.SpineProgramming_Page_classCanonicalName').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassCanonicalName.getAttribute('value');
            else
              item.textContent = inputClassCanonicalName.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_classCanonicalName'));
        }

        if(inputClassSimpleName) {
          document.querySelectorAll('.SpineProgramming_Page_classSimpleName').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassSimpleName.getAttribute('value');
            else
              item.textContent = inputClassSimpleName.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_classSimpleName'));
        }

        if(inputClassCanonicalNames) {
          document.querySelectorAll('.SpineProgramming_Page_classCanonicalNames').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputClassCanonicalNames.getAttribute('value');
            else
              item.textContent = inputClassCanonicalNames.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_classCanonicalNames'));
        }

        if(inputSaves) {
          document.querySelectorAll('.SpineProgramming_Page_saves').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputSaves.getAttribute('value');
            else
              item.textContent = inputSaves.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_saves'));
        }

        if(inputObjectTitle) {
          document.querySelectorAll('.SpineProgramming_Page_objectTitle').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectTitle.getAttribute('value');
            else
              item.textContent = inputObjectTitle.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_objectTitle'));
        }

        if(inputEditPage) {
          document.querySelectorAll('.SpineProgramming_Page_editPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputEditPage.getAttribute('value');
            else
              item.textContent = inputEditPage.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_editPage'));
        }

        if(inputUserPage) {
          document.querySelectorAll('.SpineProgramming_Page_userPage').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputUserPage.getAttribute('value');
            else
              item.textContent = inputUserPage.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_userPage'));
        }

        if(inputDownload) {
          document.querySelectorAll('.SpineProgramming_Page_download').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDownload.getAttribute('value');
            else
              item.textContent = inputDownload.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_download'));
        }

        if(inputObjectSuggest) {
          document.querySelectorAll('.SpineProgramming_Page_objectSuggest').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectSuggest.getAttribute('value');
            else
              item.textContent = inputObjectSuggest.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_objectSuggest'));
        }

        if(inputObjectText) {
          document.querySelectorAll('.SpineProgramming_Page_objectText').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputObjectText.getAttribute('value');
            else
              item.textContent = inputObjectText.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_objectText'));
        }

        if(inputSolrId) {
          document.querySelectorAll('.SpineProgramming_Page_solrId').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputSolrId.getAttribute('value');
            else
              item.textContent = inputSolrId.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_solrId'));
        }

        if(inputImportance) {
          document.querySelectorAll('.SpineProgramming_Page_importance').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputImportance.getAttribute('value');
            else
              item.textContent = inputImportance.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_importance'));
        }

        if(inputCourseNum) {
          document.querySelectorAll('.SpineProgramming_Page_courseNum').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputCourseNum.getAttribute('value');
            else
              item.textContent = inputCourseNum.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_courseNum'));
        }

        if(inputLessonNum) {
          document.querySelectorAll('.SpineProgramming_Page_lessonNum').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputLessonNum.getAttribute('value');
            else
              item.textContent = inputLessonNum.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_lessonNum'));
        }

        if(inputName) {
          document.querySelectorAll('.SpineProgramming_Page_name').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputName.getAttribute('value');
            else
              item.textContent = inputName.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_name'));
        }

        if(inputDescription) {
          document.querySelectorAll('.SpineProgramming_Page_description').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDescription.getAttribute('value');
            else
              item.textContent = inputDescription.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_description'));
        }

        if(inputPageVideoUrl) {
          document.querySelectorAll('.SpineProgramming_Page_pageVideoUrl').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageVideoUrl.getAttribute('value');
            else
              item.textContent = inputPageVideoUrl.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageVideoUrl'));
        }

        if(inputPageImageWidth) {
          document.querySelectorAll('.SpineProgramming_Page_pageImageWidth').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageWidth.getAttribute('value');
            else
              item.textContent = inputPageImageWidth.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageImageWidth'));
        }

        if(inputPageImageHeight) {
          document.querySelectorAll('.SpineProgramming_Page_pageImageHeight').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageHeight.getAttribute('value');
            else
              item.textContent = inputPageImageHeight.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageImageHeight'));
        }

        if(inputPageImageType) {
          document.querySelectorAll('.SpineProgramming_Page_pageImageType').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageType.getAttribute('value');
            else
              item.textContent = inputPageImageType.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageImageType'));
        }

        if(inputPageImageAlt) {
          document.querySelectorAll('.SpineProgramming_Page_pageImageAlt').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPageImageAlt.getAttribute('value');
            else
              item.textContent = inputPageImageAlt.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_pageImageAlt'));
        }

        if(inputPrerequisiteArticleIds) {
          document.querySelectorAll('.SpineProgramming_Page_prerequisiteArticleIds').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPrerequisiteArticleIds.getAttribute('value');
            else
              item.textContent = inputPrerequisiteArticleIds.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_prerequisiteArticleIds'));
        }

        if(inputPrerequisiteArticles) {
          document.querySelectorAll('.SpineProgramming_Page_prerequisiteArticles').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPrerequisiteArticles.getAttribute('value');
            else
              item.textContent = inputPrerequisiteArticles.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_prerequisiteArticles'));
        }

        if(inputNextArticleIds) {
          document.querySelectorAll('.SpineProgramming_Page_nextArticleIds').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputNextArticleIds.getAttribute('value');
            else
              item.textContent = inputNextArticleIds.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_nextArticleIds'));
        }

        if(inputNextArticles) {
          document.querySelectorAll('.SpineProgramming_Page_nextArticles').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputNextArticles.getAttribute('value');
            else
              item.textContent = inputNextArticles.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_nextArticles'));
        }

        if(inputLabelsString) {
          document.querySelectorAll('.SpineProgramming_Page_labelsString').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputLabelsString.getAttribute('value');
            else
              item.textContent = inputLabelsString.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_labelsString'));
        }

        if(inputLabels) {
          document.querySelectorAll('.SpineProgramming_Page_labels').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputLabels.getAttribute('value');
            else
              item.textContent = inputLabels.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_labels'));
        }

        if(inputRelatedArticleIds) {
          document.querySelectorAll('.SpineProgramming_Page_relatedArticleIds').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputRelatedArticleIds.getAttribute('value');
            else
              item.textContent = inputRelatedArticleIds.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_relatedArticleIds'));
        }

        if(inputRelatedArticles) {
          document.querySelectorAll('.SpineProgramming_Page_relatedArticles').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputRelatedArticles.getAttribute('value');
            else
              item.textContent = inputRelatedArticles.textContent;
          });
          addGlow(document.querySelector('.SpineProgramming_Page_relatedArticles'));
        }

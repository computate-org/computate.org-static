...
async function patchCompanyProduct($formFilters, $formValues, target, id, success, error) {
...
async function putimportCompanyProduct($formValues, target, id, success, error) {

...
async function searchComputateResearch($formFilters, success, error) {
  ...
  searchComputateResearchVals(filters, success, error);
}
...
function searchComputateResearchVals(filters, success, error) {

  fetch(
    '/api/research?' + $.param(filters)
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
    }).then(success).catch(error);
}

function suggestComputateResearchObjectSuggest($formFilters, $list) {
  success = function( data, textStatus, jQxhr ) {
    $list.empty();
  ...
  error = function( jqXhr, textStatus, errorThrown ) {};
  searchComputateResearchVals($formFilters, success, error);
}
...
async function patchComputateResearch($formFilters, $formValues, pk, success, error) {
  ...
  patchComputateResearchVals(pk == null ? $.deparam(window.location.search ? window.location.search.substring(1) : window.location.search) : [{name:'fq', value:'pk:' + pk}], vals, success, error);
}
...
function patchComputateResearchVal(filters, v, val, success, error) {
  var vals = {};
  vals[v] = val;
  patchComputateResearchVals(filters, vals, success, error);
}

function patchComputateResearchVals(filters, vals, success, error) {
  fetch(
    '/api/research?' + $.param(filters)
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
...
async function postComputateResearch($formValues, success, error) {
  var vals = {};
  if(success == null) {
    success = function( data, textStatus, jQxhr ) {
...
function postComputateResearchVals(vals, success, error) {
  fetch(
    '/api/research'
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
...
async function putimportComputateResearch($formValues, pk, success, error) {
  ...
  if(json != null && json !== '')
    putimportComputateResearchVals(JSON.parse(json), success, error);
}

function putimportComputateResearchVals(json, success, error) {
  fetch(
    '/api/research-import'
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}

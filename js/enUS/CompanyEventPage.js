...
async function patchCompanyEvent($formFilters, $formValues, target, id, success, error) {
...
async function putimportCompanyEvent($formValues, target, id, success, error) {

Promise.all([
    ...
    , customElements.whenDefined('sl-input')
          ...
          // PATCH displayPage
          document.querySelector('#fqCompanyService_displayPage')?.addEventListener('sl-change', (event) => {
            fqChange('CompanyService', event.target);
          });
          document.querySelector('#buttonFacetCompanyService_displayPage')?.addEventListener('click', (event) => {
            facetFieldChange('CompanyService', event.target);
          });
          document.querySelector('#pageFacetPivotCompanyService_displayPage')?.addEventListener('sl-change', (event) => {
            facetPivotChange('CompanyService', event.target);
          });
